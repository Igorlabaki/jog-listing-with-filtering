...
const Home: NextPage = () => {
  ...
  return (
    <div className="text-center  min-h-screen w-full flex flex-col bg-LightGrayishCyan">
      ...
      <div className="mr-auto mt-[-1.5rem] ml-auto w-[95%] md:[80%] top-[4.55rem] break-words  bg-white rounded-lg flex flex-col space-y-2 justify-start items-start  px-3 py-2">
